...
class FlowAugmentor:
    ...
    def spatial_transform(self, img1, dpt1, img2, dpt2, flow):
    ...
    def __call__(self,img1, dpt1, img2, dpt2, flow):
...
class SparseFlowAugmentor:
    def __init__(self, crop_size, min_scale=-0.2, max_scale=0.5, do_flip=False):
        # spatial augmentation params # 空间增强参数
        ...
        # flip augmentation params# 翻转拓展数据
        self.do_flip = do_flip
        self.h_flip_prob = 0.5
        self.v_flip_prob = 0.1

        # photometric augmentation params # 光度增强参数,函数可以随机调整图像亮度，增强训练泛化性
